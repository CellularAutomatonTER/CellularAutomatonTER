...
public class ComboBoxFormCellsEvent implements ItemListener {
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if(m_mainWindow1D.getm_comboBoxFormCells().getSelectedItem() == m_mainWindow1D.getm_stringFormCells()[0]){
			IForm rectangleForm = new RectangleForm();
			...
			IForm rectangle3DRaisedForm1D = new Rectangle3DRaisedForm1D();
			...
			IForm rectangle3DSunkForm1D = new Rectangle3DSunkForm1D();
			...
			IForm upwardTriangleForm1D = new UpwardTriangleForm1D();
